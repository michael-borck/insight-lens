    ...
    return (
      <Card className="p-6">
        <div className="text-center">
          <Bot className="w-12 h-12 text-primary-500 dark:text-primary-400 mx-auto mb-4 animate-pulse" />
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-3">
            <Bot className="w-8 h-8 text-primary-700 dark:text-primary-200" />
          ...
          <div className="space-y-1 text-sm text-primary-600 dark:text-primary-300">
        ...
        <ArrowRight className="w-5 h-5 text-primary-500 dark:text-primary-400 flex-shrink-0 mt-1" />
      </div>
    </Card>
  );
}